...
const defaultConfig = '{"lang":"en", "ftpd":false,"ftpd-user":"zetrox","ftpd-password":"zetrox","auth":false,"internet-access":true,"save-logs":true,"config-version":1}';
const defaultUsersConfig = '{"zetrox": {"username": "zetrox","password": "72ba608dbfac8d46d4aaf40f428badf85af1f929fece7480e56602b4452a71fe","mail": "","hash": "","permissions": ["console", "plugins", "filemanager", "server_settings", "zetrox_settings"]}}';
...
exports.readConfig = () => {
  if (!fs.existsSync("config.json")) {
    ...
    if (typeof parse['owner-password'] !== "undefined") {
      ...
      users__cfg['zetrox']['password'] = SHA256(parse['owner-password']).toString();
...
function detectUserLocale() {
  ...
  if(locale != 'ru' && locale != 'nl' && locale != 'hu'){
    locale = 'en';
  }
